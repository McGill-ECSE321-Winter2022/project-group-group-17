  ...
  <div id="Add_Special_Day">
    <div class="mainFrame">
      ...
      <div class="buttonPersonalFrame inputPersLabel">
        ...
        <button class="btn-success" @click="addSpecialDay(starttime, endtime)">Create Special Day
        </button>
      </div>
...
export default {
  ...
  methods : {
    addSpecialDay: function(startdatetime, enddatetime) {
      if (document.getElementById('startdatetime').value === '') {
        ...
        AXIOS.post(backendUrl + '/storehour/create?startTime=' + startdatetime + "&endTime=" + enddatetime).then(response => {
